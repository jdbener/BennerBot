...
public class ChatDisplayConfigurationPanel extends JPanel {
	...
	public ChatDisplayConfigurationPanel() {
		...
		MainGui.addComponent(nameShortenerCheckbox, "nameShortener");
		...
		MainGui.addComponent(highlightMessagesCheckbox, "HighlighMessages");
		...
		MainGui.addComponent(enableBotMessages, "enableBotMessages");
		...
		chckbxEnableUserJoin.setBounds(293, 60, 199, 23);
		add(chckbxEnableUserJoin);
		MainGui.addComponent(chckbxEnableUserJoin, "enableJoinMessages");
		...
		chckbxEnableUserLeave.setBounds(496, 60, 226, 23);
		add(chckbxEnableUserLeave);
		MainGui.addComponent(chckbxEnableUserLeave, "enableLeaveMessages");
		...
		chckbxDisplayPluginMessages.setBounds(496, 32, 199, 23);
		add(chckbxDisplayPluginMessages);
		MainGui.addComponent(chckbxDisplayPluginMessages, "enablePluginMessages");
		...
		MainGui.addComponent(chckbxFilterbots, "filterBots");
		...
		chckbxFilterCommands.setBounds(164, 60, 140, 23);
		add(chckbxFilterCommands);
		MainGui.addComponent(chckbxFilterCommands, "filterCommands");
		...
		MainGui.addComponent(messageFormatBox, "DisplayMessageFormat");
